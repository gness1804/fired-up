...
const displayStoredSessionsOnPage = (sessions) => {
  console.log('sessions from storage', sessions)
  ...
  for (var key in sessions) {
    ...
    // console.log('sessions key string', sessions[keyString])
...
$('#session-list-display').on('click', () => {
  console.log('delegation works')
})

const goToSession = (session) => {
  console.log('the target session', session)
}
